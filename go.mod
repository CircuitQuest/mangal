...
require (
	...
	github.com/luevano/libmangal v0.11.1
	github.com/luevano/luaprovider v0.9.4
	github.com/luevano/mangoprovider v0.7.5
...
require (
	...
	github.com/pdfcpu/pdfcpu v0.7.0 // indirect
