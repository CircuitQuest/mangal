...
func anilistCmd() *cobra.Command {
	...
	c.AddCommand(anilistAuthCmd())
	c.AddCommand(anilistLogoutCmd())

	return c
}

func anilistAuthCmd() *cobra.Command {
...
func anilistLogoutCmd() *cobra.Command {
	c := &cobra.Command{
		Use:   "logout",
